		...
		<div>
			...
			<div className="text-center mt-5">
				...
				<form onSubmit={handleMarkReadingBookFinished} className="my-5">
					...
					<br />
					<button type="submit" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Mark Reading Book as Finished</button>
				</form>
				<button onClick={() => handleDeleteReadingBook(readingBook.id)} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
					Delete Reading Book
				</button>
			</div>
		</div>
